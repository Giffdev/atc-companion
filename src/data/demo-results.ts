...
export const createDemoDashboardData = (referenceTime: string) => {
  ...
  const notams: Notam[] = [
    ...
    },
    {
      ...
      type: "D",
      affectedFacility: "KSEA",
      effectiveAt: toTimestamp(referenceMs, 30 * 60 * 1000),
      expiresAt: toTimestamp(referenceMs, -6 * 60 * 60 * 1000),
      text: "RWY 16C/34C CLSD DUE TO PAVEMENT REPAIR. Expect full closure 0600-1400Z daily until further notice.",
      keyword: "RWY",
      category: "RUNWAY_CLOSURE",
      isCritical: true,
      summary: "RWY 16C/34C CLSD",
      source: notamSource,
      fetchedAt: notamFetchedAt,
      isStale: isStaleAt(notamFetchedAt, "notam", referenceMs)
    },
