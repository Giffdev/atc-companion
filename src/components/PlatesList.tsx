          ...
          <div className="flex flex-col gap-3 xl:flex-row xl:items-start xl:justify-between">
            <div className="space-y-3">
              <div className="flex flex-wrap items-center gap-2">
                <span className="rounded-full border border-violet-500/25 bg-violet-500/10 px-2.5 py-1 font-data text-[11px] tracking-[0.2em] text-violet-300">
                  {plate.procedureType}
                </span>
                {plate.runway ? (
                  <span className="rounded-full border border-aviation-border bg-black/20 px-2.5 py-1 font-data text-[11px] tracking-[0.2em] text-aviation-text">
                    RWY {plate.runway}
                  </span>
                ) : null}
              </div>
